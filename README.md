# Que tal praticar?
Vamos criar um Sistema de Catálogo de Produtos com Streams e Optional.

## Crie uma lista de produtos, onde cada produto tenha:

* Nome (String)

* Preço (Double)

## Realize as seguintes operações usando Streams:
